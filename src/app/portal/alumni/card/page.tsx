      ...
      <div ref={containerRef} className="max-w-3xl mx-auto space-y-5">
        ...
        <div className="card-section flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-xs sm:text-sm mt-0.5">Your virtual NAAKIMS alumni ID</p>
          </div>
          <button
            ...
            <div className="relative flex items-start justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-white/40 text-[8px] sm:text-[9px] font-semibold uppercase tracking-[0.15em]">Alumni Member</p>
                </div>
              </div>
              <div className="px-2 py-0.5 rounded-md bg-white/15 text-white/90 text-[8px] sm:text-[9px] font-bold uppercase tracking-wider">
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-between mt-2 sm:mt-3">
                <div className="flex items-center gap-4 sm:gap-6">
                  ...
                  <div>
                    <p className="text-white/30 text-[7px] sm:text-[8px] font-semibold uppercase tracking-[0.15em]">Graduation</p>
                    <p className="text-white/90 text-[10px] sm:text-[12px] font-bold mt-0.5">Class of {mockUser.graduationYear}</p>
                  </div>
                  <div className="hidden sm:block">
                    <p className="text-white/30 text-[8px] font-semibold uppercase tracking-[0.15em]">Chapter</p>
                    <p className="text-white/90 text-[12px] font-bold mt-0.5">{mockUser.chapter}</p>
                  </div>
                </div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-white/10 flex items-center justify-center shrink-0">
                  {mockUser.photoUrl ? (
                    ...
                    <span className="text-base sm:text-lg font-bold text-white/70">{mockUser.name.split(' ')[1]?.charAt(0) || 'A'}</span>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#008751]/[0.03] rounded-xl px-4 py-4 sm:px-5 sm:py-5">
            ...
            <div className="space-y-2.5">
              {[
                ...
                { label: 'Specialization', value: mockUser.specialization },
                { label: 'Institution', value: mockUser.hospital },
              ].map((item, i) => (
                <div key={i}>
            ...
            <div className="space-y-2.5">
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-1">
                  ...
                  <p className="text-[12px] sm:text-[13px] font-medium text-gray-700">Active Member</p>
                </div>
              </div>
              <div>
                <p className="text-[9px] sm:text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Membership Type</p>
                <p className="text-[12px] sm:text-[13px] text-gray-700 font-medium mt-0.5">{mockUser.membershipType}</p>
              </div>
              <div>
                <p className="text-[9px] sm:text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Graduation Year</p>
                <p className="text-[12px] sm:text-[13px] text-gray-700 font-medium mt-0.5">{mockUser.graduationYear}</p>
              </div>
            </div>
            <Link
