                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-10 items-start">
                    ...
                    <div className="lg:col-span-3 flex items-center gap-4 lg:flex-col lg:items-start">
                      <div className="t-avatar relative w-14 h-14 sm:w-16 sm:h-16 lg:w-36 lg:h-36 rounded-full overflow-hidden ring-2 ring-[#00D084]/20 ring-offset-2 ring-offset-white shrink-0">
